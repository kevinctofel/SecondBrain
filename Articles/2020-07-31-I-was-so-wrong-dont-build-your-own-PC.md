...
---
About a month ago I suggested that [most people should build their own PC at least once](/n/articles/should-everyone-build-their-own-pc-at-least-once/). That was right after I built a decent gaming PC on a $900 budget. And so far it has served me well, not just for gaming but for coding too: I'm really liking the [Windows Subsystem for Linux and the way it works with Visual Code](/n/articles/interesting-developing-in-ubuntu-through-vs-code-running-in-wsl2-1/).

![Creating a website in Visual Code using Linux in Windows 10](../Images/gatsby-in-wsl2.jpg)

And then about a week later, [I spent $68 to add a second storage drive](/n/articles/this-68-storage-upgrade-was-well-worth-it-even-if-it-was-twice-the-cost-of-an-ssd/). I didn't necessarily need the additional space just yet but I was enamoured by the massive speed boost in data throughput. So I dropped the money on it, making the $900 PC closer to a $1,000 PC.
...
![Thermaltake P3](../Images/thermaltake-p3.jpg)
...
![Liquid coooled CPU](../Images/liquid-cooled-aio.jpg)
